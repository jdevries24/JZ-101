...
class front_end:
	...
	def __init__(self,file_name):
		#the file name is the name of the c file sans file extention 
		self.asm = ""
		self.global_decl = ""
...
if __name__ == "__main__":
	#calls and runs the assembler. 
	#Modify base for working directiory if working in
	#non local directiory
	base = ""
